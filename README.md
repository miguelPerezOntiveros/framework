...
- on project creator backend ext, don't add "page", "theme" and "portlet" tables to maker_mike project
	- possibly no user and userTypes either, but if I leave those, then add those back to the project specific section of the sidebar
- check all php TODOs
...
- project conf is too large to fit on datatable
	- add a "Copy as JSON"
	- leave the "_showName (_projectName)" displayed
